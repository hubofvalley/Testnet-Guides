...
echo "export DAEMON_HOME=$(find $HOME -type d -name ".0gchain")" >> ~/.bash_profile
echo "export DAEMON_DATA_BACKUP_DIR=$(find $HOME/.0gchain/cosmovisor -type d -name "backup")" >> ~/.bash_profile
