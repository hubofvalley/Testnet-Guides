...
# Script: 0g_turbo_zgs_node_snapshot.sh
...
SNAPSHOT_URL="https://turbo-zgs-node-snapshot-0g.grandvalleys.com/turbo_zgs_snapshot.tar.gz"
...
### Header ###
echo "### 0G Turbo ZGS Node Snapshot Application ###"
