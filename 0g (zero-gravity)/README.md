...
- [ZeroGravity](#zerogravity)
  ...
  - [Validator Node Manual Installation](#validator-node-manual-installation)
    ...
    - [8. Set Custom Ports in app.toml](#8-set-custom-ports-in-apptoml)
    - [9. Download genesis.json](#9-download-genesisjson)
    - [10. Add Seeds to config.toml](#10-add-seeds-to-configtoml)
    - [11. Add Peers to config.toml](#11-add-peers-to-configtoml)
    - [12. Configure Pruning to Save Storage (Optional)](#12-configure-pruning-to-save-storage-optional)
    - [13. Open RPC Endpoints](#13-open-rpc-endpoints)
    - [14. Open JSON-RPC Endpoints](#14-open-json-rpc-endpoints)
    ...
    - [17. Disable Indexer (Optional)](#17-disable-indexer-optional)
